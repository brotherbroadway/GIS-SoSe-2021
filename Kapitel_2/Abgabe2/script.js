"use strict";
var Abgabe2_2Aufgabe1;
(function (Abgabe2_2Aufgabe1) {
    // - Aufgabe 1a -
    console.log("--- Aufgabe 1a ---");
    function min(..._manyNum) {
        let minResult;
    ...
    function isEven(_insertedNumb) {
        let evenOddResult;
        let theNum = _insertedNumb;
    ...
    // -- c2 --
    let s1 = new Student("Ruder", "Jona", 2, 265274); // declaring new students
    let s2 = new Student("Mustermann", "Max", 1, 123456);
    let s3 = new Student("Tubby", "Tele", 5, 987654);
    // -- c3 --
    let uniStudents = [s1, s2, s3]; // student array
...
})(Abgabe2_2Aufgabe1 || (Abgabe2_2Aufgabe1 = {}));
var Abgabe2_2Aufgabe2;
(function (Abgabe2_2Aufgabe2) {
    // Aufgabe 2a
    console.log("--- Aufgabe 2a ---");
    function backwards(_givenArr) {
        let backwArr = new Array;
        for (let i = _givenArr.length - 1; i >= 0; i--) { // starts from last array entry
    ...
    function join(_firstArr, _manyMoreArr) {
    ...
    function split(_arrToSplit, _index1, _index2) {
        ...
        for (let i = _index1; i <= _index2; i++) { // if everything is in order, pushes from index1 to index2
            splitArr.push(_arrToSplit[i]);
        }
        return splitArr;
    }
...
})(Abgabe2_2Aufgabe2 || (Abgabe2_2Aufgabe2 = {}));
var Abgabe2_2Aufgabe3;
(function (Abgabe2_2Aufgabe3) {
    // Aufgabe 3a
    ...
    let rectArr = [rect2, rect3, rect4]; // rectangle array
    for (let i = 0; i < rectArr.length; i++) {
        rectArr[i].drawRect(); // fills 3 random rectangles
    }
})(Abgabe2_2Aufgabe3 || (Abgabe2_2Aufgabe3 = {}));
